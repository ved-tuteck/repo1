      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex gap-8">
            ...
            <a href="#sales" className="text-gray-700 hover:text-blue-600 font-medium transition">Sales</a>
            <a href="#careers" className="text-gray-700 hover:text-blue-600 font-medium transition">Careers</a>
            <a href="/reviews" onClick={handleReviewsClick} className="text-gray-700 hover:text-blue-600 font-medium transition">Reviews</a>
        ...
        {mobileMenuOpen && (
          <div className="md:hidden pb-4 space-y-3">
            ...
            <a href="#sales" className="block text-gray-700 hover:text-blue-600 py-2">Sales</a>
            <a href="#careers" className="block text-gray-700 hover:text-blue-600 py-2">Careers</a>
            <a href="/reviews" onClick={handleReviewsClick} className="block text-gray-700 hover:text-blue-600 py-2">Reviews</a>
